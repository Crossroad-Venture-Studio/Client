...
const visualViewportResizeHandler = () => {
  ...
  document.getElementById('chat-input').setAttribute('value', `${document.documentElement.scrollHeight} ${Platform.windowSize.height} ${vv.height + vv.offsetTop} | ${document.documentElement.scrollTop} ${vv.height} ${vv.offsetTop} ${vv.pageTop}`);
