...
const visualViewportResizeHandler = () => {
  ...
  document.getElementById('chat-input').setAttribute('value', `${vvt} ${vvh} ${Platform.windowSize} | ${getComputedStyle(document.documentElement).getPropertyValue('--viewport-height')}`);
  // document.body.style.marginTop = `${vvt}px`;
